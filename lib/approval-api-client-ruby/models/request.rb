...
module ApprovalApiClient
  ...
  class Request
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'number_of_children')
        self.number_of_children = attributes[:'number_of_children']
      end

      if attributes.has_key?(:'number_of_finished_children')
      ...
      if attributes.has_key?(:'requester_name')
    ...
    def hash
      [id, state, decision, reason, workflow_id, created_at, updated_at, number_of_children, number_of_finished_children, owner, requester_name, name, description].hash
    end
